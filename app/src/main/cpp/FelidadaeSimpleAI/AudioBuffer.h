...
namespace FelidadaeAudio {
	...
	public:
		...
		//Create, destroy
		AudioBuffer(const unsigned int& numOfChannels, const unsigned int& channelLength): 
			numOfChannels_(numOfChannels), channelLength_(channelLength) {};
		...
		unsigned int get_allLength() const { 
			return numOfChannels_ * channelLength_; 
		}
